...
#find and assert add student visible
          ...
          sleep 1
          find('#applicationContainer > div > div.js-overlay > div > div > div.table__wrapper__header.table__wrapper__header--student > table > thead > tr > td.session-cell--manage.js-cancelAddStudent').click
          sleep 1
          page.should have_no_css('#applicationContainer > div > div.js-overlay > div > div > div.table__wrapper.table__wrapper--student > table > tbody > tr:nth-child(1) > td.session-cell--start.session-cell--start--student.js-addStudent')
    end
end
