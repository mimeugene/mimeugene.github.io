...
describe 'Hamburger', :js => true do
    it 'button closed' do
        ...
        find('#applicationContainer > div > header > button').click
        sleep 1
        page.should have_no_css('#applicationContainer > div > header > nav > div.nav--main__logout.grid-cell > a')
        page.should have_no_css('#applicationContainer > div > header > nav > div.nav--main__manage.grid-cell > a')
    end
end
