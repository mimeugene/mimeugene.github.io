...
describe 'Notes', :js => true do
    it 'saved edits' do
        ...
        find('#applicationContainer > div > div.js-overlay > div > div.stage.stage--edit > div > div > aside > div > ul > li:nth-child(1)', :text => "testestest").click
        find(:css, '#applicationContainer > div > div.js-overlay > div > div.stage.stage--edit > div > div > article > section > textarea').set("editeditedit")
        find('#applicationContainer > div > div.js-overlay > div > div.stage.stage--edit > div > div > article > section.edit-notes__buttons.grid > button.button--save-note.grid-cell.js-saveNote').click
        sleep 1
        find('#applicationContainer > div > div.js-overlay > div > div.stage.stage--edit > div > div > aside > div > ul > li:nth-child(1)', :text => "editeditedit")
