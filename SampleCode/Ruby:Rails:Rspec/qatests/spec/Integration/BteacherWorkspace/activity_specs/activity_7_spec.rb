...
describe 'Activity menu', :js => true do
    it 'correct for reading level 7' do
...
#carefully changes reading level
        ...
        page.should have_css('#applicationContainer > div > div.stage.grid.grid--center.stage--workspace.js-stage > div.stage__menu.stage__menu--right.grid.js-menuActivity > div.js-buttonWords > button > img.icon-words-filled.st-hidden')
        sleep 1
        #assert stage stories has no elements
        find('#applicationContainer > div > div.js-matrix > div > nav.matrix__menu > div > div > a:nth-child(3) > span').click
        page.should have_no_css('#applicationContainer > div > div.stage.grid.grid--center.stage--workspace.js-stage > div.stage__menu.stage__menu--right.grid.js-menuActivity > div.js-buttonWords > button > img.icon-words-filled.st-hidden')
        page.should have_no_css('#applicationContainer > div > div.stage.grid.grid--center.stage--workspace.js-stage > div.stage__menu.stage__menu--right.grid.js-menuActivity > div.js-buttonPhrases > button > img.icon-phrases')
        page.should have_no_css('#applicationContainer > div > div.stage.grid.grid--center.stage--workspace.js-stage > div.stage__menu.stage__menu--right.grid.js-menuActivity > div.js-buttonTiles > button > img.icon-tiles')
    end
end
