...
#carefully changes reading level
        ...
        sleep 2
        find('.icon-text--vertical.button--letters').click
        page.should have_css('#applicationContainer > div > div.stage.grid.grid--center.stage--workspace.js-stage > div.stage__menu.stage__menu--right.grid.js-menuActivity > div.js-buttonLetters > button')
        page.should have_css('#applicationContainer > div > div.stage.grid.grid--center.stage--workspace.js-stage > div.stage__menu.stage__menu--right.grid.js-menuActivity > div.js-buttonWords > button > img.icon-words')
