...
describe 'Activity menu', :js => true do
    it 'not shown for lvl 1 leveled texts' do
...
#carefully changes reading level
        ...
        page.should have_no_css('#applicationContainer > div > div.stage.grid.grid--center.stage--workspace.js-stage > div.stage__menu.stage__menu--right.grid.js-menuActivity > div.js-buttonLetters > button > img.icon-letters-filled.st-hidden')
    end
end
