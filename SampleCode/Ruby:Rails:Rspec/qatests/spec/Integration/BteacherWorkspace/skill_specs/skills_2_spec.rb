...
describe 'Skills stage 2', :js => true, :long => true do
    it 'showed onsets and rimes and leveled texts' do
        ...
        find('#applicationContainer > div > div.js-overlay > div > div.stage.stage--edit > div > div > div.reading-stage-chooser.grid.grid--wrap.grid--center > a:nth-child(2)').click
